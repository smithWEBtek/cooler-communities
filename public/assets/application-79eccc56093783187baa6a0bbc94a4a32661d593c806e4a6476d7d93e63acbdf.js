...
function categoryTabHandler() {
  $('img.survey__category-image').on('click', function (event) {
    ...
    document.getElementById(event.currentTarget.id).classList.add('survey__category-image-selected')
  })
}
